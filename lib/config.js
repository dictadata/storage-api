...
var config = {
  ...
  smt: {
    ...
    //$_accounts: "mysql|host=localhost;user=dicta;password=data;database=storage_node|api_accounts|=userid",

    // my-api configuration
    $_settings: "elasticsearch|http://localhost:9200|api_settings|!key",
    //$_settings: "mssql|server=localhost;username=dicta;password=data;database=storage_node|api_settings|=key",
    //$_settings: "mysql|host=localhost;user=dicta;password=data;database=storage_node|api_settings|=key",

    $_docs: "elasticsearch|http://localhost:9200|api_docs|!docid",
    //$_docs: "mssql|server=localhost;username=dicta;password=data;database=storage_node|api_docs|=docid",
    //$_docs: "mysql|host=localhost;user=dicta;password=data;database=storage_node|api_docs|=docid",
  },
...
if (process.env.NODE_ENV === 'development') {
  ...
  //config.smt.$_accounts = "mysql|host=localhost;user=dicta;password=data;database=storage_node|api_accounts|=userid",

  config.smt.$_settings = "elasticsearch|http://localhost:9200|api_settings|!key";
  //config.smt.$_settings = "mssql|server=localhost;username=dicta;password=data;database=storage_node|api_settings|=key",
  //config.smt.$_settings = "mysql|host=localhost;user=dicta;password=data;database=storage_node|api_settings|=key",

  config.smt.$_docs = "elasticsearch|http://localhost:9200|api_docs|!docid";
  //config.smt.$_docs = "mssql|server=localhost;username=dicta;password=data;database=storage_node|api_docs|=docid",
  //config.smt.$_docs = "mysql|host=localhost;user=dicta;password=data;database=storage_node|api_docs|=docid",
