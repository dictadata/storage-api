...
if (process.env.NODE_ENV === 'development') {
  ...
  //config.stm.$_accounts: 'mssql|server=localhost;username=dicta;password=data;database=storage_node|api_accounts|=userid',
 
  config.smt.$_settings = 'elasticsearch|http:/localhost:9200|api_settings|!key';
  //config.stm.$_settings: 'mssql|server=localhost;username=dicta;password=data;database=storage_node|api_settings|=key',

  config.smt.$_docs = 'elasticsearch|http:/localhost:9200|api_docs|!docid';
  //config.stm.$_docs: 'mssql|server=localhost;username=dicta;password=data;database=storage_node|api_docs|=docid',
